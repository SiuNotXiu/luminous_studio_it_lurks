...
public class player_flashlight_direction : MonoBehaviour
{
    ...
    void OnValidate()
    {
        ...
        if (object_arm_with_flashlight == null)
            object_arm_with_flashlight = object_sprite_sheet_mask.transform.Find("arm_with_flashlight").gameObject;
        ...
        if (bones_head_normal == null)
            bones_head_normal = object_sprite_sheet_mask.transform.Find("sprite_sheet_normal").Find("bone_1").Find("bone_2").Find("bone_3").gameObject;
